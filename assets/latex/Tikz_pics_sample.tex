...
%interation 1
%\begin{figure}
\raisebox{-0.5\totalheight}{\begin{tikzpicture}[thick, scale=0.9]
...
%iteration 2
%\begin{figure}
\raisebox{-.7\totalheight}{\begin{tikzpicture}[thick, scale=0.9]
\node[shape=ellipse, minimum height = 100pt, minimum width=4pt, draw=black, fill=white]  at (0,0) {$S_0\:$};
...
%iteration 3
%\begin{figure}
\raisebox{-.8\totalheight}{\begin{tikzpicture}[thick, scale=0.9]
