...
\begin{document}
\scriptsize \noindent Math 314 Linear Algebra \hfill Section 3.4 Examples 
\normalsize\medskip


\thispagestyle{empty}
For each set of vectors, $T$, determine whether or not they are (i) linearly independent or dependent, (ii) span $\mathbb{R}^n$ for the appropriate $n$, (iii) form a basis for $\mathbb{R}^n$ for the appropriate $n$.

\begin{enumerate}
\item $T_1=\left\{ \mathbf{v}_1= \vecthree{1}{2}{4},\mathbf{v}_2= \vecthree{1}{3}{9},\mathbf{v}_3= \vecthree{1}{1}{-1} \right\}$\\

\medskip
\noindent  $A = \begin{bmatrix} 1 & 1 & 1 \\ 2 & 3 & 1 \\ 4 & 9 & -1 \end{bmatrix} \qquad \to \qquad R = \begin{bmatrix} 1 & 0 & 2 \\ 0 & 1 & -1 \\ 0 & 0 & 0 \end{bmatrix}$
\vfill
