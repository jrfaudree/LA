...
\textbf{output:} $\left\{ q_i \: | \: \overline{q}_i \not = 0_n \right \}$ where $q_i$'s are
	\begin{itemize}
	\item orthonormal
	\item linearly independent and 
	\item produce the same collection of linear combinations.\\
	\end{itemize}

\textbf{Crucial Point:} If the $a_i$'s form a \emph{basis}, then the $q_i$'s form an orthonormal basis.

\item Example: $a_1=(1,-1,1),\: a_2=(1,0,1), \: a_3=(1,1,2)$
\newpage
Here are the steps again in different form:\\
